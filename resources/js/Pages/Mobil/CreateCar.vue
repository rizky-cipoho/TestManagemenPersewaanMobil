        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg pb-10">
                    ...
                    <div class="px-10">
                        <form @submit.prevent="form.post(route('mobil.store'))">
                            <table class="">
                                <tbody>
                                    <tr>
                                        <th>Merek Mobil</th>
                                    ...
                                    <tr>
                                        <th>Gambar Mobil</th>
                                        <th>: <input type="file" name="" class="border px-2 py-1 rounded" @change="changeImage" required @input="form.image = $event.target.files[0]" accept="image/*"></th>
                                    </tr>
                                    <tr>
                                    </tr>
                                </tbody>
